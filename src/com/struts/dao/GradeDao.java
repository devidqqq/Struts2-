...
public class GradeDao {
	...
	public int addGrade(Connection con, Grade grade) throws Exception {
	...
	public int updateGrade(Connection con, Grade grade) throws Exception {
	...
	public Grade gradeById(Connection con, String gradeId) throws Exception {
	...
	public int deleteGrade(Connection con,String gradeId) throws Exception{
	...
	public boolean existClassAtgrade(Connection con,String gradeId) throws Exception{
